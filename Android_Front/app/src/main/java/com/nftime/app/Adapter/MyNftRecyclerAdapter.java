...
public class MyNftRecyclerAdapter extends RecyclerView.Adapter<MyNftRecyclerAdapter.ViewHolder> {
    private ArrayList<NftWorkObj> nftWorks;
    private Context context;
    private String klaytnAddress;

    public MyNftRecyclerAdapter(Context context, String klaytnAddress){
    ...
    @NonNull
    @Override
    public MyNftRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_artitem, parent, false);
        return new MyNftRecyclerAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MyNftRecyclerAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
