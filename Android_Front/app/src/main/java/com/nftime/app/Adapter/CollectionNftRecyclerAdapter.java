...
public class CollectionNftRecyclerAdapter extends RecyclerView.Adapter<CollectionNftRecyclerAdapter.ViewHolder> {
    private ArrayList<NftWorkObj> nftWorks;
    private Context context;
    String klaytnAddress;

    public CollectionNftRecyclerAdapter(Context context, String klaytnAddress){
    ...
    @NonNull
    @Override
    public CollectionNftRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_artitem, parent, false);
        return new CollectionNftRecyclerAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CollectionNftRecyclerAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        holder.onBind(nftWorks.get(position));

        holder.cardView_art.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                intent.putExtra("owner_address", klaytnAddress);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            cardView_art = itemView.findViewById(R.id.cardView_art);
